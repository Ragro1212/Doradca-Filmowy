...
using namespace std;
// Struktura przechowująca daneFilmow o filmach
struct Film {
    string tytul;
    double akcja;
...
void pytania(){
    ...
    for(int i=0;i<10;i++){
        ...
        switch(wylosowana){
            ...
            cin>>wybor;
            if(wybor=="TAK"){
                if(prUz.akcja<3)prUz.akcja+=0.2+prUz.akcja*0.1;
                if(prUz.romantycznosc<3)prUz.romantycznosc+=0.1+prUz.romantycznosc*0.1;
                if(prUz.komedia<3)prUz.komedia+=0.0;
                if(prUz.dramatycznosc<3)prUz.dramatycznosc+=0.1+prUz.dramatycznosc*0.1;
                if(prUz.realizm>0)prUz.realizm-=0.2+prUz.realizm*(-0.1);
                if(prUz.familijnosc>0)prUz.familijnosc-=0.1+prUz.familijnosc*(-0.1);
            }
            else{
                if(prUz.akcja>0)prUz.akcja-=0.1+prUz.akcja*(-0.1);
                if(prUz.romantycznosc<3)prUz.romantycznosc+=0.0;
                if(prUz.komedia<3)prUz.komedia+=0.0;
                if(prUz.dramatycznosc>0)prUz.dramatycznosc-=0.1+prUz.dramatycznosc*(-0.1);
                if(prUz.realizm<3)prUz.realizm+=0.2+prUz.realizm*0.1;
                if(prUz.familijnosc<3)prUz.familijnosc+=0.1+prUz.familijnosc*0.1;
            }
            break;
            ...
            cin>>wybor;
            if(wybor=="TAK"){
                if(prUz.akcja<3)prUz.akcja+=0.3+prUz.akcja*0.1;
                if(prUz.romantycznosc>0)prUz.romantycznosc-=0.1+prUz.romantycznosc*(-0.1);
                if(prUz.komedia>0)prUz.komedia-=0.1+prUz.komedia*(-0.1);
                if(prUz.dramatycznosc<3)prUz.dramatycznosc+=0.1+prUz.dramatycznosc*0.1;
                if(prUz.realizm>0)prUz.realizm-=0.1+prUz.realizm*(-0.1);
                if(prUz.familijnosc>0)prUz.familijnosc-=0.1+prUz.familijnosc*(-0.1);
            }
            else{
                if(prUz.akcja>0)prUz.akcja-=0.3+prUz.akcja*(-0.1);
                if(prUz.romantycznosc<3)prUz.romantycznosc+=0.1+prUz.romantycznosc*0.1;
                if(prUz.komedia<3)prUz.komedia+=0.1+prUz.komedia*0.1;
                if(prUz.dramatycznosc>0)prUz.dramatycznosc-=0.1+prUz.dramatycznosc*(-0.1);
                if(prUz.realizm<3)prUz.realizm+=0.1+prUz.realizm*0.1;
                if(prUz.familijnosc<3)prUz.familijnosc+=0.1+prUz.familijnosc*0.1;
            }
            ...
            cin>>wybor;
            if(wybor=="TAK"){
                if(prUz.akcja<3)prUz.akcja+=0.1+prUz.akcja*0.1;
                if(prUz.romantycznosc<3)prUz.romantycznosc+=0.0;
                if(prUz.komedia>0)prUz.komedia-=0.1+prUz.komedia*(-0.1);
                if(prUz.dramatycznosc<3)prUz.dramatycznosc+=0.3+prUz.dramatycznosc*0.1;
                if(prUz.realizm<3)prUz.realizm+=0.1+prUz.realizm*0.1;
                if(prUz.familijnosc>0)prUz.familijnosc-=0.1+prUz.familijnosc*(-0.1);
            }
            else{
                ...
                if(prUz.romantycznosc<3)prUz.romantycznosc+=0.0;
                if(prUz.komedia<3)prUz.komedia+=0.1+prUz.komedia*0.1;
                if(prUz.dramatycznosc>0)prUz.dramatycznosc-=0.3+prUz.dramatycznosc*(-0.1);
            ...
            if(wybor=="TAK"){
                if(prUz.akcja>0)prUz.akcja-=0.1+prUz.akcja*(-0.1);
                if(prUz.romantycznosc<3)prUz.romantycznosc+=0.1+prUz.romantycznosc*0.1;
                if(prUz.komedia<3)prUz.komedia+=0.3+prUz.komedia*0.1;
                if(prUz.dramatycznosc>0)prUz.dramatycznosc-=0.1+prUz.dramatycznosc*(-0.1);
                if(prUz.realizm<3)prUz.realizm+=0.0;
                if(prUz.familijnosc<3)prUz.familijnosc+=0.1+prUz.familijnosc*0.1;
            }
                ...
                if(prUz.akcja<3)prUz.akcja+=0.1+prUz.akcja*0.1;
                if(prUz.romantycznosc>0)prUz.romantycznosc-=0.1+prUz.romantycznosc*(-0.1);
                if(prUz.komedia>0)prUz.komedia-=0.3+prUz.komedia*(-0.1);
                if(prUz.dramatycznosc<3)prUz.dramatycznosc+=0.1+prUz.dramatycznosc*0.1;
                if(prUz.realizm<3)prUz.realizm+=0.0;
                if(prUz.familijnosc>0)prUz.familijnosc-=0.1+prUz.familijnosc*(-0.1);
            }
            ...
            if(wybor=="TAK"){
                ...
                if(prUz.dramatycznosc<3)prUz.dramatycznosc+=0.1+prUz.dramatycznosc*0.1;
                if(prUz.realizm>0)prUz.realizm-=0.2+prUz.realizm*(-0.1);
                if(prUz.familijnosc<3)prUz.familijnosc+=0.2+prUz.familijnosc*0.1;
            }
            else{
                if(prUz.akcja<3)prUz.akcja+=0.1+prUz.akcja*0.1;
                if(prUz.romantycznosc<3)prUz.romantycznosc+=0.0;
                ...
                if(prUz.realizm<3)prUz.realizm+=0.2+prUz.realizm*0.1;
                if(prUz.familijnosc>0)prUz.familijnosc-=0.2+prUz.familijnosc*(-0.1);
            }
            break;
            case 6:
            ...
            if(wybor=="TAK"){
                if(prUz.akcja>0)prUz.akcja-=0.1+prUz.akcja*(-0.1);
                if(prUz.romantycznosc<3)prUz.romantycznosc+=0.3+prUz.romantycznosc*0.1;
                if(prUz.komedia<3)prUz.komedia+=0.2+prUz.komedia*0.1;
                if(prUz.dramatycznosc>0)prUz.dramatycznosc-=0.1+prUz.dramatycznosc*(-0.1);
                if(prUz.realizm<3)prUz.realizm+=0.0;
                if(prUz.familijnosc<3)prUz.familijnosc+=0.1+prUz.familijnosc*0.1;
            }
                ...
                if(prUz.akcja<3)prUz.akcja+=0.1+prUz.akcja*0.1;
                if(prUz.romantycznosc>0)prUz.romantycznosc-=0.2+prUz.romantycznosc*(-0.1);
                if(prUz.komedia>0)prUz.komedia-=0.1+prUz.komedia*(-0.1);
                if(prUz.dramatycznosc<3)prUz.dramatycznosc+=0.1+prUz.dramatycznosc*0.1;
                if(prUz.realizm<3)prUz.realizm+=0.0;
                if(prUz.familijnosc>0)prUz.familijnosc-=0.1+prUz.familijnosc*(-0.1);
            ...
            if(wybor=="TAK"){
                if(prUz.akcja<3)prUz.akcja+=0.1+prUz.akcja*0.1;
                if(prUz.romantycznosc>0)prUz.romantycznosc-=0.1+prUz.romantycznosc*(-0.1);
                if(prUz.komedia>0)prUz.komedia-=0.2+prUz.komedia*(-0.1);
                if(prUz.dramatycznosc<3)prUz.dramatycznosc+=0.1+prUz.dramatycznosc*0.1;
                if(prUz.realizm>0)prUz.realizm-=0.1+prUz.realizm*(-0.1);
                if(prUz.familijnosc>0)prUz.familijnosc-=0.2+prUz.familijnosc*(-0.1);
            }
            ...
            if(wybor=="TAK"){
                ...
                if(prUz.romantycznosc>0)prUz.romantycznosc-=0.1+prUz.romantycznosc*(-0.1);
                if(prUz.komedia>0)prUz.komedia-=0.1+prUz.komedia*(-0.1);
                if(prUz.dramatycznosc<3)prUz.dramatycznosc+=0.2+prUz.dramatycznosc*0.1;
                if(prUz.realizm<3)prUz.realizm+=0.0;
                if(prUz.familijnosc>0)prUz.familijnosc-=0.1+prUz.familijnosc*(-0.1);
            }
            else{
            ...
            if(wybor=="TAK"){
                if(prUz.akcja>0)prUz.akcja-=0.1+prUz.akcja*(-0.1);
                if(prUz.romantycznosc<3)prUz.romantycznosc+=0.2+prUz.romantycznosc*0.1;
                if(prUz.komedia<3)prUz.komedia+=0.2+prUz.komedia*0.1;
                if(prUz.dramatycznosc>0)prUz.dramatycznosc-=0.1+prUz.dramatycznosc*(-0.1);
                if(prUz.realizm<3)prUz.realizm+=0.1+prUz.realizm*0.1;
                if(prUz.familijnosc<3)prUz.familijnosc+=0.3+prUz.familijnosc*0.1;
            }
            else{
                if(prUz.akcja<3)prUz.akcja+=0.1+prUz.akcja*0.1;
                if(prUz.romantycznosc>0)prUz.romantycznosc-=0.1+prUz.romantycznosc*(-0.1);
            ...
            if(wybor=="TAK"){
                ...
                if(prUz.akcja>0)prUz.akcja-=0.2+prUz.akcja*(-0.1);
                if(prUz.romantycznosc<3)prUz.romantycznosc+=0.1+prUz.romantycznosc*0.1;
                if(prUz.komedia<3)prUz.komedia+=0.1+prUz.komedia*0.1;
                if(prUz.dramatycznosc>0)prUz.dramatycznosc-=0.1+prUz.dramatycznosc*(-0.1);
                if(prUz.realizm<3)prUz.realizm+=0.1+prUz.realizm*0.1;
            ...
            case 32:
            cout <<"Czy lubisz filmy Stanisława Bareji?: ";
            cin>>wybor;
            if(wybor=="TAK"){
                if(prUz.akcja<3)prUz.akcja+=0.0;
                if(prUz.romantycznosc>0)prUz.romantycznosc-=0.0;
            ...
            if(wybor=="TAK"){
                ...
                if(prUz.romantycznosc>0)prUz.romantycznosc+=0.0;
                if(prUz.komedia<3)prUz.komedia+=0.0;
                if(prUz.dramatycznosc>0)prUz.dramatycznosc-=0.2+prUz.dramatycznosc*(-0.1);
                if(prUz.realizm<3)prUz.realizm+=0.1+prUz.realizm*0.1;
                if(prUz.familijnosc<3)prUz.familijnosc+=0.1+prUz.familijnosc*0.1;
            }
            break;
...
// Funkcja polecajÄ…ca filmy na podstawie algorytmu adaptacyjnego
vector<string> rekomendowaneFilmy(const vector<Film>& daneFilmow, const Film& prUz, double prog) {
    ...
    // Obliczanie podobieĹ„stwa dla kaĹĽdej kategorii
    ...
    // Normalizacja podobieĹ„stwa
    podobienstwo /= sumaWagi;

    // Sprawdzanie, czy film speĹ‚nia prĂłg podobieĹ„stwa
...
int main() {
    // daneFilmow treningowe - przykładowe filmy z ocenami w trzech kategoriach
    ...
    do{
        ...
        switch(menu){
            case 1:{
                ...
                cout<<"Ilosc potrzebnych zmniejszen progu do polecenia filmu: "<<liczbaZmniejszen-1<<"\n";
                }
                else{
                    cout<<"Zresetuj wpierw pytania.\n";
                }
                break;
             }
             case 2:{
